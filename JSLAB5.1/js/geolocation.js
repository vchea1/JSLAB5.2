...
function success(position) {
    ...
    const url = `https://www.openstreetmap.org/#map=13/${position.coords.latitude}/${position.coords.longitude}`;
    mapLink.setAttribute("href", url);
    mapLink.setAttribute("target", "_blank");
    mapLink.textContent = "Open in my browser";
}
...
function error() {
    ...
    statusMsg.textContent = "Sorry! we were not able to find you.";
}
