...
// STEP 1d: Create or select the image element for RoboHash
let roboImage = document.querySelector('#battery img');
if (!roboImage) {
    roboImage = document.createElement('img');
    roboImage.alt = "Robo avatar based on battery";
    roboImage.style.marginTop = "1em";
    roboImage.style.maxWidth = "200px";
    document.querySelector('#battery').appendChild(roboImage);
}
...
function updateBatteryStatus(battery) {
    ...
    chargeMeter.value = percent;

    // STEP 5: Update RoboHash image based on battery percent
